        ...
        comiclist.append(
            {
                ...
                "issues": str(num_chapters) if num_chapters else "0",
...
def get_manga_details(mal_id):
    ...
    return {
        ...
        "last_chapter": str(num_chapters) if num_chapters else None,
        "last_volume": str(num_volumes) if num_volumes else None,
        "tags": tags,
        "author": author,
